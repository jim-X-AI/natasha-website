...
const Hero = () => {
  ...
  const showcaseItems = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1571781926291-c477ebfd024b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80"
    },
  ];
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden pt-20">
      ...
      >
        ...
        >
          ...
          >
            <span className="flex items-center justify-center">
              Explore Categories
              <svg className="ml-2 md:ml-3 w-4 h-4 md:w-5 md:h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />
              </svg>
            </span>
          </Link>
        ...
        >
          <span className="text-white/80 text-xs md:text-sm mb-2">Scroll to Explore</span>
